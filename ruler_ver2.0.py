...
class Drow(object):
    def __init__(self):
        ...
        self.labelnn = self.c.create_text(135, 1000,
                                        ...
                                        font=lbl_font,
                                        fill="#FFFFFE")
        self.labelside = self.c.create_text(135, 960,
                                          anchor='center',
                                          activefill='red',
                                          text=self.side,
                                          font=lbl_font,
    ...
    def DetectSide(self):
        self.ScTl.GetTankSide(x=self.X0, y=self.Y0)
        self.ScTl.TankSideFilter(showDig = 1)
        return 0

        # parser.TankSideFilter()

    def CheckTrace(self, side = 0):
        self.NN()
